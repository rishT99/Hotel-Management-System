...
import java.sql.*;
public class ReceptionL extends JFrame implements ActionListener{
JTextField t1;
JPasswordField p1;
JButton b1,b2;
JLabel l1,l2;
...
public void actionPerformed(ActionEvent ae){
    ...
    String str ="select * from receptionl where username ='"+username+"' and password = '"+password+"'";
    try{
        ResultSet rs = c.s.executeQuery(str);
        if(rs.next()){
            new Dashboard().setExtendedState(JFrame.MAXIMIZED_BOTH);
